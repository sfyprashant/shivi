...
<html lang="en">
   <head>
      ...
      <!-- fevicon -->
      <link rel="icon" href="img/unnamed1.png" type="image/gif" />
         ...
         <div id="content">
                           ...
                           <div class="col-md-3 logo_section">
                              <div class="full">
                                 <div class="center-desk">
                                    <div class="logo">
                                       <a href="index.html"><img src="img/unnamed1.png" alt="#"></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
            ...
            <section class="slider_section">
               <div class="banner_main">
                  <img class="banner_image" src="images/bg_main2.jpg" alt="#"/>
                  <div class="container-fluid padding3">
                     <div class="row">
                        <div class="col-md-12">
                           <div class="text-bg">
                              <a href="https://tcvvip6.com/#/register?invitationCode=328524261760">Play now</a>
                              <a href="https://t.me/tclottery_x66">Get Prediction</a>
                           </div>
                        </div>
                     </div>
                  </div>
                           ...
                           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                              <div class="address">
                                 ...
                                 <ul class="Links_footer">
                                    <li><a href="https://t.me/tclottery_x66" target="_blank"><i class="fa-brands fa-telegram"></i></a></li>
                                 </ul>
                                 <ul class="Links_footer">
